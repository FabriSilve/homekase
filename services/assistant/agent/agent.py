...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        "- Summarizing URLs and text content\n"
        "- Extracting wisdom, insights, ideas, and recommendations from content\n"
        "- Explaining and reviewing code\n"
        "- Analyzing logs for errors and root causes\n"
        "- Searching the web\n"
        "- Improving writing quality\n"
        "- Translating text\n"
        "- Finding logical fallacies and blindspots in arguments\n"
        "- Red-teaming plans and providing encouragement\n\n"
